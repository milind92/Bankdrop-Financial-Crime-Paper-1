...
Blinded human inter-coder reliability and subsequent adjudication were completed by Ausma and Milind on 23 July 2026. Publication-safe aggregate results are available in [Human ICR Completion](outputs/human_validation/HUMAN_ICR_COMPLETION.md). Coder workbooks, evidence packets, rationales, and record-level adjudication material remain controlled and are not published.

## Repository Contents

- `code/`: deterministic Phase 1–4 scripts, the human-validation summariser, guarded orchestrator, public-output exporter, and repository verifier.
- `outputs/`: privacy-safe Phase 1–4 aggregate outputs, corpus-screening audit totals, and aggregate human-validation results.
