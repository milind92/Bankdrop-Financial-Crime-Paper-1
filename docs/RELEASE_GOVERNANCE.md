...
The public repository contains deterministic Phase 1–4 code, aggregate results, methods documentation, and aggregate human-validation evidence. It excludes manuscript and submission work, incomplete or excluded LLM phases, and all raw or record-level material.

## Release Rules

1. Run the unit tests and repository verifier before every public push or tag.
2. Export controlled results only through the fail-closed allowlist.
